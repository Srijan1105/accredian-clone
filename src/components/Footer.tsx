...
const footerLinks = {
  ...
  Programs: [
    { label: "Product Management", href: "#domains" },
    { label: "Data Science & AI", href: "#domains" },
    { label: "Leadership", href: "#domains" },
    { label: "Digital Transformation", href: "#domains" },
  ],
  "Contact Us": [
...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#0d1b6e] text-white">
      {/* Main Footer */}
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center gap-2 mb-4">
              <div className="w-10 h-10 bg-white rounded-lg flex items-center justify-center">
                <span className="text-[#1a237e] font-bold text-lg">A</span>
              </div>
              <div>
                <span className="font-bold text-xl">Accredian</span>
                <span className="block text-xs text-blue-300 -mt-1">Enterprise</span>
              </div>
            </div>
            <p className="text-blue-200 text-sm leading-relaxed mb-5">
              Cultivate high-performance teams through expert learning. Transforming
              enterprises with industry-leading training programs.
            </p>
            {/* Social Links */}
            <div className="flex gap-2">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="w-8 h-8 bg-white/10 hover:bg-[#00bcd4] rounded-full flex items-center justify-center transition-colors duration-200"
                >
                  {social.icon}
                </a>
              ))}
      ...
      <div className="border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <button
            onClick={scrollToTop}
            className="w-9 h-9 bg-white/10 hover:bg-[#00bcd4] rounded-full flex items-center justify-center transition-colors duration-200 cursor-pointer"
